...
export default function Step1() {
  ...
  const iphoneSteps = [
    { n: "01", title: "Open Contacts", desc: 'Go to your Contacts app, then tap "Lists" in the top left corner.', img: "iphone-step1.jpg" },
    { n: "02", title: "Export All Contacts", desc: 'Press and hold "All Contacts", then tap "Export" from the menu that appears.', img: "iphone-step2.jpg" },
    { n: "03", title: "Select the Right Fields", desc: 'Make sure images are NOT checked — this will cause the export to fail. Select only "Names" and "Phone Numbers" (mobile, work, home, etc.).', img: "iphone-step3.jpg" },
    { n: "04", title: "Confirm the Export", desc: 'Tap "Done" in the top right corner to confirm your selections.', img: "iphone-step4.jpg" },
    { n: "05", title: "Send to Your Computer", desc: "Choose Gmail or Mail to send the exported file to yourself so it's accessible on your computer.", img: "iphone-step5.jpg" },
    { n: "06", title: "Convert the File", desc: "The file will be in .VCF format. Search Google for a VCF to CSV converter and convert it to .CSV, .XLS, or .XLSX so it opens as a spreadsheet.", img: "iphone-step6.jpg" },
  ];

  const androidSteps = [
    {
      n: "01", title: "Go to Google Contacts",
      desc: (<>Open <a href="https://contacts.google.com" target="_blank" rel="noreferrer" className="step-link">contacts.google.com</a> on your Android device or computer. Make sure you are signed into the correct Google account.</>),
      img: "android-step1.png",
    },
    { n: "02", title: "Click Export", desc: 'In the left sidebar, click "Export". On mobile, tap the menu icon first to find it.', img: "android-step2.png" },
    { n: "03", title: "Choose CSV Format", desc: 'Select any of the CSV options — Google CSV is recommended — then click "Export". Your contacts will download as a spreadsheet-ready file.' },
  ];
    ...
    <div className="step-page">
      <header className="step-header">
        <div className="step-header-inner">
          ...
          <p className="step-subtitle">
            ...
            intentional your list, the more opportunities you create.
          </p>
        </div>
      </header>
      ...
      <main className="step-content">
        ...
        <div className="step-tabs">
          <button
            className={`step-tab ${section === "list-building" ? "active" : ""}`}
            onClick={() => setSection("list-building")}
          >
        ...
        {section === "list-building" && (
          <>
            ...
            <div className="step-tabs">
              <button
                className={`step-tab ${device === "iphone" ? "active" : ""}`}
              ...
              <button
                className={`step-tab ${device === "android" ? "active" : ""}`}
                  ...
                  <div className="step-row-body">
                    ...
                    {s.img && (
                      <div className="step-img-wrap">
                        <img src={`/images/${s.img}`} alt={s.title} className="step-img" onError={(e) => { e.currentTarget.style.display = "none"; }} />
                      </div>
                    )}
                  </div>
                </div>
